...
c=3e8;
ak=0.4e-6;%晶格常数
b5=load('E:\first paper continue\2016-4-24\pm-参数优化\波导宽度变化\波导宽度改变_deltaz=0.025A\k-f.txt');
k5= b5(:,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
b2=load('E:\first paper continue\2016-4-24\pm-参数优化\dynamic\0.8&0.16eVnew/k-f.txt');
k2= b2(:,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
b3=load('E:\first paper continue\2016-4-24\pm-参数优化\dynamic\0.6&0.12eV\k-f.txt');
k3= b3(:,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
b=load('E:\first paper continue\2016-4-24\pm-参数优化\dynamic\0.4&0.08eV\k-f.txt');
k1= b(:,1);
...
% b4=load('C:\TTTT\ok\del=0.85r1=0.2A\f-kdelta-f=0.04THz.txt');
% k4= b4(:,1);
...
% hold on;
legend('V_g=9.58V','V_g=6.13V','V_g=3.45V','V_g=1.53V');
