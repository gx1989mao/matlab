...
c=3e8;
ak=0.4e-6;%晶格常数
b5=load('E:\first paper continue\45度30T\pm-参数优化\波导宽度变化\deltaz=0.035A\k-f.txt');
k5= b5(:,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
b2=load('E:\first paper continue\45度30T\pm-参数优化\波导宽度变化\波导宽度改变_deltaz=0.025A\k-f.txt');
k2= b2(:,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
b3=load('E:\first paper continue\45度30T\pm-30T\k-f.txt');
k3= b3(:,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
b=load('E:\first paper continue\45度30T\pm-参数优化\波导宽度变化\波导宽度改变_deltaz=-0.025A\k-f.txt');
k1= b(:,1);
...
b4=load('E:\first paper continue\45度30T\pm-参数优化\波导宽度变化\deltaz=---0.035A\deltaz=-0.035A\k-f.txt');
k4= b4(:,1);
...
% hold on;
% legend('deltaz=0.035A','deltaz=0.025A','deltaz=0A','deltaz=-0.025A','deltaz=-0.035A');
