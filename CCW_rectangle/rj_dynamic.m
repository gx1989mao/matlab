...
c=3e8;
ak=0.24e-6;%晶格常数修改
b5=load('E:\耦合腔\矩形耦合腔研究\final result\0.52eV&0.14eV&OK_参数研究\rj\rj=0.06A\k-f.txt');
k5= b5(:,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
b2=load('E:\耦合腔\矩形耦合腔研究\final result\0.52eV&0.14eV&OK_参数研究\rj\rj=0.08A\k-f.txt');
k2= b2(:,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
b3=load('E:\耦合腔\矩形耦合腔研究\final result\0.52eV&0.14eV&OK\k-f.txt');
k3= b3(:,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
b=load('E:\耦合腔\矩形耦合腔研究\final result\0.52eV&0.14eV&OK_参数研究\rj\rj=0.13A\k-f.txt');
k1= b(:,1);
...
b4=load('E:\耦合腔\矩形耦合腔研究\final result\0.52eV&0.14eV&OK_参数研究\rj\rj=0.16A\k-f.txt');
k4= b4(:,1);
