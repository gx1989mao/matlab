...
c=3e8;
ak=0.36e-6;%晶格常数
b5=load('E:\耦合腔\六角晶格CCW\simulations\0.20&0.74&0.36_参数研究\rk\rk=0.08a\k-f.txt');
k5= b5(:,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
b2=load('E:\耦合腔\六角晶格CCW\simulations\0.20&0.74&0.36_参数研究\rk\rk=0.10a\k-f.txt');
k2= b2(:,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
b3=load('E:\耦合腔\六角晶格CCW\simulations\0.20&0.74&0.36_c初步仿真\k-f.txt');
k3= b3(:,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
b=load('E:\耦合腔\六角晶格CCW\simulations\0.20&0.74&0.36_参数研究\rk\rk=0.14a\k-f.txt');
k1= b(:,1);
...
b4=load('E:\耦合腔\六角晶格CCW\simulations\0.20&0.74&0.36_参数研究\rk\rk=0.16a\k-f.txt');
k4= b4(:,1);
...
% hold on;
% legend('R_k=0.08a','R_k=0.10a','R_k=0.12a','R_k=0.13a','R_k=0.16a');
